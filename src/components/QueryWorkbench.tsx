  ...
  return (
    <Card>
      <SectionTitle eyebrow="Query workbench" title={`Closed-loop query optimisation view (${filtered.length}/${rows.length})`}>
        Query diagnostics and workbench are combined here. Each card shows brand AI visibility, competitor names, winning source types, leading citation domain and mapped owned URLs.
      </SectionTitle>
